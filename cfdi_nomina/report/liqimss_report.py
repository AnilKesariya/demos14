...
class LiqIMSSReport(models.AbstractModel):
    ...
    t_sdi = fields.Float(string="SDI Salario diario integrado")
    t_inc = fields.Float(string="Inc. Incapacidades")
    t_aus = fields.Float(string="Aus. Ausentismo")
    t_pe = fields.Float(string="C.F. Cuota fija")
    t_ae3 = fields.Float(string="Exc. Excedente 3 SMGDF")
    t_ed = fields.Float(string="Exc. Prestaciones en dinero")
    t_gmp = fields.Float(string="G.M.P. Gastos médicos para pensionados")
    t_rt = fields.Integer(string="R.T. Riesgo de trabajo")
    t_iv = fields.Float(string="I.V. Invalidez y vida")
    t_gua = fields.Float(string="G.P.S. Guarderias y prestaciones sociales")
    t_total = fields.Float(string="Total")
    suma_patron = fields.Float(string="Cuota patrón")
    suma_trab = fields.Float(string="Cuota trabajador")
    dias_trabajados = fields.Float(string="Dias")
    aus = fields.Float(string="aus. ausentismo")
    inc = fields.Float(string="Incapacidades")
